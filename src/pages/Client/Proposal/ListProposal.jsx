      ...
      <div className="">
        {datas.map((item) => (
          <div className="border-b flex items-center py-5">
            ...
            <div className="w-4/5 text-lg underline text-[#1677ff] cursor-pointer" onClick={()=>{
              if(item?.[FormProposal.Status] === 'P'){
                navigate("/xac-nhan-hop-dong?proposalId=" + item?.[FormProposal.ProposalId])
              }else{
